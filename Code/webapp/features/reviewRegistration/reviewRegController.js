...
// User Story #1140
        ...
        function acceptProfile (user) {
            ...
            success_msg();
 // User Story #1140
            var log1 = {faculty: user._id, firstName: user.firstName, lastName: user.lastName, facultyemail: user.email, rank: user.rank, gender: user.gender, department: user.department, college: user.college, action: "RegApproved", type: "faculty"};
        ...
        function rejectProfile (user) {
            ...
            reject_msg();
// User Story #1140
            var log = { faculty: user._id, firstName: user.firstName, lastName: user.lastName, facultyemail: user.email, rank: user.rank, gender: user.gender, department: user.department, college: user.college, action: "RegDenied", type: "faculty"};
